...
import type { QueryHavingNodeData, SqlOperator } from '@buildweaver/libs';
...
const LOGGER_PREFIX = 'QueryHavingNode';
...
export const QueryHavingNode = ({ id, data }: NodeProps<QueryHavingNodeData>) => {
  const updateData = useNodeDataUpdater<QueryHavingNodeData>(id);
  ...
  return (
    <div className="relative">
      <NodeChrome badge="HAVING" label="Having" description="SQL HAVING filter" preview={preview}>
        {/* Data input */}
