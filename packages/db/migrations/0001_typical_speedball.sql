...
--> statement-breakpoint
ALTER TABLE "project_graphs" ADD CONSTRAINT "project_graphs_project_id_projects_id_fk" FOREIGN KEY ("project_id") REFERENCES "public"."projects"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "project_graphs_project_id_idx" ON "project_graphs" USING btree ("project_id");